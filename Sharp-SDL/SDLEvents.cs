...
namespace Sharp_SDL
{
    ...
    public unsafe delegate bool SDL_EventFilter(void* userdata, SDL_Event* @event);
    ...
    public static unsafe partial class SDLEvents
    {
        ...
        [DllImport("SDL3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void SDL_SetEventFilter([NativeTypeName("SDL_EventFilter")] IntPtr filter, void* userdata);

        [DllImport("SDL3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: NativeTypeName("bool")]
        public static extern byte SDL_GetEventFilter([NativeTypeName("SDL_EventFilter *")] IntPtr* filter, void** userdata);

        [DllImport("SDL3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [return: NativeTypeName("bool")]
        public static extern byte SDL_AddEventWatch([NativeTypeName("SDL_EventFilter")] IntPtr filter, void* userdata);

        [DllImport("SDL3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void SDL_RemoveEventWatch([NativeTypeName("SDL_EventFilter")] IntPtr filter, void* userdata);

        [DllImport("SDL3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void SDL_FilterEvents([NativeTypeName("SDL_EventFilter")] IntPtr filter, void* userdata);
        ...
        [DllImport("SDL3", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern int SDL_GetEventDescription([NativeTypeName("const SDL_Event *")] SDL_Event* @event, [NativeTypeName("char *")] sbyte* buf, int buflen);
    }
}
